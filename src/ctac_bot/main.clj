...
(defn usage
  ...
  (s/join
    \newline
    ["Runs the ctac-bot Discord bot."
     ""
     "Usage: ctac-bot [options]"
     ""
     "Options:"
     options-summary
     ""]))
...
(defn -main
  ...
  [& args]
  (try
    (log/info "Starting ctac-bot on Clojure" (clojure-version) "/" (System/getProperty "java.vm.vendor") "JVM" (System/getProperty "java.vm.version") (str "(" (System/getProperty "os.name") "/" (System/getProperty "os.arch") ")"))
